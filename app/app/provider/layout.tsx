...
const navigation = [
  { name: "Tableau de bord", href: "/app/provider/dashboard", icon: LayoutDashboard },
  { name: "Mes missions", href: "/app/provider/jobs", icon: Briefcase },
  { name: "Calendrier", href: "/app/provider/calendar", icon: Calendar },
  { name: "Mes devis", href: "/app/provider/quotes", icon: FileText },
  { name: "Mes factures", href: "/app/provider/invoices", icon: Receipt },
  { name: "Mes avis", href: "/app/provider/reviews", icon: Star },
  { name: "Mes documents", href: "/app/provider/compliance", icon: Shield },
];

const secondaryNav = [
  { name: "Paramètres", href: "/app/provider/settings", icon: Settings },
  { name: "Aide", href: "/app/provider/help", icon: HelpCircle },
];
