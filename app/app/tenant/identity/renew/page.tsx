...
function RenewCNIContent() {
  ...
  if (error && step !== "error") return (
    <div className="container mx-auto px-4 py-6 max-w-lg">
      ...
      <Button asChild className="mt-4"><Link href="/app/tenant/identity"><ArrowLeft className="mr-2 h-4 w-4" />Retour</Link></Button>
    </div>
  );
  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-lg">
      <div className="mb-6">
        <Button asChild variant="ghost" size="sm" className="mb-3 -ml-2"><Link href="/app/tenant/identity"><ArrowLeft className="mr-1 h-4 w-4" />Retour</Link></Button>
        ...
        {step === "success" && (
          <motion.div key="success" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <Card><CardContent className="py-12 text-center">
              ...
              <Button asChild><Link href="/app/tenant/identity">Retour</Link></Button>
            </CardContent></Card>
          </motion.div>
        )}
        ...
        {step === "error" && (
          <motion.div key="error" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <Card><CardContent className="py-12 text-center">
              ...
              <div className="flex gap-2 justify-center"><Button variant="outline" asChild><Link href="/app/tenant/identity">Annuler</Link></Button><Button onClick={() => setStep("intro")}>Réessayer</Button></div>
            </CardContent></Card>
          </motion.div>
        )}
      </AnimatePresence>
