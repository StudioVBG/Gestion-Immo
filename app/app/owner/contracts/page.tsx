...
import { Search, FileText, Users, Plus, Calendar, Euro, ArrowRight } from "lucide-react";
import { useLeases, useProperties } from "@/lib/hooks";
...
export default function OwnerContractsPage() {
  ...
  const { data: leases = [], isLoading } = useLeases(propertyIdFilter || undefined);
