...
export default async function GlobalDiagnosticsPage() {
  ...
  if (!properties || properties.length === 0) {
    return (
      <div className="container mx-auto py-12 text-center max-w-md">
        ...
        <Button asChild>
          <Link href="/app/owner/properties/new">Ajouter un logement</Link>
        </Button>
      </div>
    );
  }
  ...
  // if (properties.length === 1) redirect(`/app/owner/properties/${properties[0].id}/diagnostics`);
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="grid grid-cols-1 gap-4">
          {properties.map((property) => (
            <Link key={property.id} href={`/app/owner/properties/${property.id}/diagnostics`}>
